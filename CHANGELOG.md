...
- Docker action is pinned to the same commit SHA as the parent workflow to avoid
  security issues thanks to [@mgovers](https://github.com/mgovers)
  ([#26](https://github.com/dieghernan/cff-validator/issues/26))
